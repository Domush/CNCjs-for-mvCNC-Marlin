  ...
  shuttleControlEvents = {
    ...
    JOG_SPEED: (event, { speed }) => {
      ...
      if (speed === 'increase') {
        ...
        newSpeeds.feedrate =
          feedrate + feedrateFactor < FEEDRATE_MAX ? toFixed(feedrate + feedrateFactor) : FEEDRATE_MAX;
      } else {
        ...
        newSpeeds.feedrate =
          feedrate - feedrateFactor > FEEDRATE_MIN ? toFixed(feedrate - feedrateFactor) : FEEDRATE_MIN;
      }
