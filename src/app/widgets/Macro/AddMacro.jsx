...
class AddMacro extends PureComponent {
  ...
  render() {
    ...
    return (
      <Modal size="large" onClose={actions.closeModal} title={i18n._('Add New Macro')} disableOverlay>
          ...
          <div style={modalBodyStyle}>
            ...
            >
              ...
              <div className="form-group">
                ...
                <Textarea rows="4" maxLength={MAX_CHARACTERS} className="form-control" name="description" value="" />
              </div>
            </Form>
          </div>
