...
const WarningModal = ({ onContinue, onIgnoreWarning, onCancel, invalidLine }) => (
  <Modal size="md" onClose={onContinue} style={modalStyle} disableOverlay>
    ...
    <Modal.Footer style={modalFooterStyle}>
      ...
      <Button style={{ backgroundColor: '#3e85c7', color: 'white', backgroundImage: 'none' }} onClick={onContinue}>
        Continue Job
      </Button>
      <Button style={{ backgroundColor: '#3e85c7', color: 'white', backgroundImage: 'none' }} onClick={onIgnoreWarning}>
