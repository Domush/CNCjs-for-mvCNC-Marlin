...
class VisualizerWidget extends PureComponent {
  ...
  actions = {
    ...
    handleRun: () => {
      ...
      console.assert(
        includes([WORKFLOW_STATE_IDLE, WORKFLOW_STATE_PAUSED], workflow.state) || activeState === GRBL_ACTIVE_STATE_HOLD
      );
  ...
  shuttleControlEvents = {
    ...
    VISUALIZER_VIEW: (_, { type }) => {
      const { to3DView, toTopView, toFrontView, toRightSideView, toLeftSideView } = this.actions.camera;
