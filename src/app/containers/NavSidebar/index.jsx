    ...
    return (
      <div className={styles.Sidebar}>
        ...
        {/* <NavSidebarLink
                    ...
                    label="Firmware"
                /> */}
        <NavSidebarLink url="" icon="fa fa-question" label="Help" onClick={() => actions.openModal(MODAL_HELP)} />
        <NavSidebarLink url="" onClick={() => actions.openModal(MODAL_PREFERENCES)} icon="fa fa-cog" label="" />
