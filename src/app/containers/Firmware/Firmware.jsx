...
import { Toaster, TOASTER_INFO, TOASTER_DANGER, TOASTER_UNTIL_CLOSE } from '../../lib/toaster/ToasterLib.js';
import ToolsNotificationModal from '../../components/ToolsNotificationModal/Modal.js';
import styles from './index.styl.js';
import InputController from './Settings/Inputs/InputController.js';
import GRBL_SETTINGS from '../../../server/controllers/Grbl/constants.js';
import NotConnectedWarning from './NotConnectedWarning.js';
import WidgetConfig from '../../widgets/WidgetConfig.js';
import ToolModalButton from '../../components/ToolModalButton/ToolModalButton.js';
            ...
            <div className={styles.buttonsContainer}>
              <div className={styles.buttonsTop}>
                {this.state.initiateFlashing ? (
                  ...
                  >
                    This feature exists to flash the GRBL firmware onto compatible Arduino boards only! Improper
                    flashing could damage your device on port: {this.state.port}.
                  </ToolsNotificationModal>
                ) : (
                  ''
                )}
              ...
              <div className={styles.buttonsMiddle}>
                ...
                <TooltipCustom content="Save your current GRBL settings to your device" location="default">
                  <ToolModalButton onClick={this.download} icon="fas fa-file-export" disabled={canClick}>
                    Export Settings
                  </ToolModalButton>
                </TooltipCustom>
                <TooltipCustom content="Restore the settings for your current machine profile" location="default">
                  <ToolModalButton onClick={this.restoreSettings} icon="fas fa-undo" disabled={!canSendSettings}>
                    Restore Defaults
                  </ToolModalButton>
                </TooltipCustom>
              </div>
