...
const Settings = () => {
  ...
  const handleRestoreClick = () => {
    Confirm({
      ...
      content:
        'All your current settings will be removed. Are you sure you want to restore default settings on CNCjs4Marlin?',
  ...
  const importSettings = (e) => {
    ...
    Confirm({
      ...
      content:
        'All your current settings will be replaced. Are you sure you want to import your settings on CNCjs4Marlin?',
  ...
  return (
    <Fieldset legend="Settings">
      <Button primary style={{ margin: 0 }} onClick={handleRestoreClick}>
        Restore Default CNCjs4Marlin Settings
      </Button>
      ...
      <div style={{ display: 'flex', gap: '1rem' }}>
        ...
        <Button primary type="button" title="Export Macros" style={{ marginBottom: '1rem' }} onClick={exportSettings}>
