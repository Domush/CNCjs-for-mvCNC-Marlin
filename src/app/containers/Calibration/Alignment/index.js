          ...
          if (clearPrevious) {
            setShapes((prev) => {
              const updated = prev[shapeType].map((shape) =>
                shape.id === shapeID ? { ...shape, label, isActive, show } : { ...shape, isActive: false }
              );
              return {
                ...prev,
        ...
        <>
          <div className={styles.alignmentContainer}>
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              ...
              {introComplete && <Step actions={actions} onChange={onChange} currentAction={currentAction} />}
            ...
            >
              {introComplete ? (
                ...
                <>
                  ...
                  <p style={{ width: '100%', fontWeight: 'bold' }}>
                    Since many CNCs run on two independent rails in the Y-axis, misalignment between these rails can
